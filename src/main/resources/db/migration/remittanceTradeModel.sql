...
FROM (SELECT tit.id,
      ...
      FROM TBL_IME_TRADE tit
               ...
               INNER JOIN TBL_IME_SETTLEMENT tis
                          ON tis.PAYMENT_CODE = tit.PAYMENT_CODE AND tis.CONTRACT_NO = tit.CONTRACT_NO AND
                             tis.CONTRACT_DETAIL_NO = tit.CONTRACT_DETAIL_NO
