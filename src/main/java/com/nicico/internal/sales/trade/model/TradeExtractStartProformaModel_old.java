...
//		    COALESCE(tipm.C_WORKFLOW_APPROVE_STATUS, '0') AS PREINVOCE_STATUS,
//		    '0' AS LC_STATUS,
...
//		         LEFT JOIN (
//		    SELECT tipm.*,
//		           ROW_NUMBER() OVER (PARTITION BY C_PAYMENT_CODE, N_CONTRACT_NO ORDER BY C_WORKFLOW_APPROVE_STATUS) AS rn
//		    FROM T_INS_PERFORMA_MASTER tipm WHERE tipm.C_WORKFLOW_APPROVE_STATUS = 'CANCELED' OR tipm.C_WORKFLOW_APPROVE_STATUS IS NULL
...
//		  AND (tipm.C_WORKFLOW_APPROVE_STATUS IS NULL OR tipm.C_WORKFLOW_APPROVE_STATUS ='CANCELED')
//		ORDER BY tit.CONTRACT_DATE DESC
//		""")
//public class TradeExtractStartProformaModel_old implements Serializable {
//
//	@Serial
