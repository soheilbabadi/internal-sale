//package com.nicico.internal.sales.gaam.model;
//
//
...
//@Builder
//@Entity
//@Table(name = "T_INS_GAAM")
//public class GaamModel extends BaseClassModel {
//
//	@Serial
//	private static final long serialVersionUID = 1L;
//
//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_INS_GAAM")
//	@SequenceGenerator(name = "SEQ_INS_GAAM", sequenceName = "SEQ_INS_GAAM", allocationSize = 1)
//	private Long id;
//
//
//	@Schema(description = "نام بانک صادر کننده اوراق گام")
//	@Column(name = "C_ISSUER_BANK_NAME", length = 200)
//	private String issuerBankName;
//
//
//	@Schema(description = "کد بانک صادر کننده اوراق گام")
...
//
//	@Schema(description = "تاریخ صدور اوراق گام")
