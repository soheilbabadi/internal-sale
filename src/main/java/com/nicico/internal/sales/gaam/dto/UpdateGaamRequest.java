...
//@NoArgsConstructor
//@Data
//public class UpdateGaamRequest implements Serializable {
//
//	@Serial
//	private static final long serialVersionUID = 1L;
//
//	@Schema(description = "شناسه اورق گام", example = "1")
//	private Long id;
//
//	// ==================== فیلدهای بانکی ====================
...
//
//	@Schema(description = "کد سپام (شماره اورق گام)", example = "1234-5678-9012-3456")
//	private String sepamCode;
//
//	@Schema(description = "شناسه خزانه داری کل کشور", example = "1234-5678-9012-3456")
//	private String treasuryId;
//
//	@Schema(description = "تاریخ صدور اورق گام", example = "1404-01-15")
//	private Date issueDate;
//
//	@Schema(description = "تاریخ سررسید اورق گام", example = "1404-03-15")
