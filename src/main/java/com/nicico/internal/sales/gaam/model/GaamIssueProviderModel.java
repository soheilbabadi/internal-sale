...
//        ROW_NUMBER() OVER (
//            PARTITION BY tipd.F_PERFORMA_MASTER_ID
//            ORDER BY tipd.ID
//        ) AS RN
//    FROM T_INS_PERFORMA_DETAIL tipd
//),
//filtered_master AS (
//    SELECT
...
//        NVL(tipm.C_WORKFLOW_APPROVE_STATUS, 'NOT_STARTED')
//            AS C_WORKFLOW_APPROVE_STATUS
//
//    FROM T_INS_PERFORMA_MASTER tipm
//
//    INNER JOIN first_detail tipd
...
//)
//		""")
//public class GaamIssueProviderModel implements Serializable {
//	@Serial
