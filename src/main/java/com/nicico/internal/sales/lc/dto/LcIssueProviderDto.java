...
@NoArgsConstructor
@Data
public class LcIssueProviderDto implements Serializable {
	@Serial
	...
	public static class Info extends LcIssueProviderDto {
		@Serial
	...
	public static class Create extends LcIssueProviderDto {
		@Serial
